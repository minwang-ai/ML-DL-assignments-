...
for (i=0; i<nx; i++)
  ...
  SUPPLEMENT CODE HERE
      */
        ...
        for(m=0;m<ny;m++)
        {
            tmp[i][p]=tmp[i][p] + u[i][m]*cy[p]*cosf((2.0*m+1)*p*ny_1);
        }
  ...
  SUPPLEMENT CODE HERE
      */
        ...
        for(m=0;m<nx;m++)
        {
            ...
            c[p][j]=c[p][j] + tmp[m][j]*cx[p]*cosf((2.0*m+1)*p*nx_1);
        }
     }
...
for (i=0; i<nx; i++)
  ...
  SUPPLEMENT CODE HERE
       */
        ...
        for(p=0;p<ny;p++)
        {
            tmp[i][m]=tmp[i][m] + c[i][p]*cy[p]*cosf((2.0*m+1)*p*ny_1);
        }
...
for (m=0; m<nx; m++)
  ...
  SUPPLEMENT CODE HERE
      */
        ...
        for(p=0;p<nx;p++)
        {
            u[m][j]=u[m][j] + tmp[p][j]*cy[p]*cosf((2.0*m+1)*p*nx_1);
        }
    }
